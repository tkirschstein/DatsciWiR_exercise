...
```{r, exe-1, collapse=TRUE, echo=TRUE, cache=TRUE}
...
```{r, exe-2, collapse=TRUE, echo=TRUE, cache=TRUE}
# old time: 12.58 sec.
...
```{r, exe-3, collapse=TRUE, echo=TRUE, cache=TRUE}
# old time: 11.85 sec.
n <- 10^6                 # number of trials
system.time({
...
```{r, exe-4, collapse=TRUE, echo=TRUE, cache=TRUE}
# old time: 12.27 sec.
n <- 10^6          # number of trials
...
```{r, exe-5, collapse=TRUE, echo=TRUE, cache=TRUE}
n <- 50
i.vec <- numeric(n)
...
```{r, exe-6, collapse=TRUE, echo=TRUE, cache=TRUE}
n <- 10
...
```{r, exe-7, collapse=TRUE, echo=TRUE, cache=TRUE}
